...
- Building production **Agentic RAG infrastructure for legal research** at BlackCoat AI — LangGraph ReAct pipelines, Zilliz hybrid retrieval, served via a dedicated **FastMCP** server so external agents can invoke legal intelligence as native tools
